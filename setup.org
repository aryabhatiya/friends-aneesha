...
* Setup GIT
** Prepare [[README.md]]
#+call: fwrite("README.md",  concat("# ", module[0] , ""))

#+RESULTS:
: nil
#+call: fread("README.md")
...
** Git Init
#+NAME: gitinit
#+BEGIN_SRC sh :var name="" :var project=concat("", module[0], ".git")
git init
...
#+call: fwrite("README.md", readme())

#+RESULTS:
: nil

#+NAME: readme
#+BEGIN_SRC sh :var src="setup.org" :var dst="README.md" :noweb yes :post bages()
...
(progn
(switch-to-buffer-other-window "*README.md*")
(erase-buffer)
(insert (concat  buf  "\n" mod "\n" "===============" "\n" end))
(other-window 1))
#+END_SRC
